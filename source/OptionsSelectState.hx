...
class OptionsSelectState extends MusicBeatState
{

    //Copié el FreeplayState y lo adapté xd
    ...
    var leVanilla:Bool = false;
    var leMinigame:Bool = false;

	private var iconArray:Array<HealthIcon> = [];

	override function create()
	{
	//	var initSonglist = CoolUtil.coolTextFile(Paths.txt('ye'));
			...
			switch (songs[curSelected].songName) {
				...
				case 'Appearance':
					if(accepted)
						{
							trace("Aperancelol");
							FlxG.switchState(new OptionsApperance());
						}
				case 'Misc':
					if(accepted)
						{
